...
class TripReviewControllerTest {
    ...
    void rateTrip_Success() throws Exception {
        TripRatingRequest request = new TripRatingRequest(1L, 5, "Excellent!");
    ...
    void rateTrip_InvalidRequest() throws Exception {
        TripRatingRequest request = new TripRatingRequest(null, 6, ""); // Invalid: null ID, rating > 5, empty review
